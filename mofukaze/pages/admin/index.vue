  ...
  <section class="admin-dashboard">
    <header class="dashboard-header">
      ...
      <div class="header-actions">
        <button class="ghost-button" @click="navigateTo('/admin/login')">
          管理员登录
        </button>
    ...
    <div v-else-if="!isAuthorized" class="locked-panel">
      ...
      <button class="primary-button" @click="navigateTo('/admin/login')">
        去登录
      </button>
    </div>
...
.primary-button {
  background: rgba(92, 148, 232, 0.38);
  color: rgba(15, 24, 42, 0.96);
}

.ghost-button {
  background: rgba(255, 255, 255, 0.18);
  color: rgba(15, 24, 42, 0.85);
}

.primary-button:hover:not(:disabled),
.ghost-button:hover {
  box-shadow: 0 8px 24px rgba(82, 142, 220, 0.24);
...
.stat-card::after {
  background: linear-gradient(135deg, rgba(255, 255, 255, 0.45), transparent 62%);
  content: "";
  inset: 0;
  opacity: 0.3;
  pointer-events: none;
...
.tone-blue .stat-icon { color: #4e86dc; }
.tone-pink .stat-icon { color: #d95f8f; }
.tone-mint .stat-icon { color: #3f9e8a; }
.tone-violet .stat-icon { color: #806fd6; }
.tone-amber .stat-icon { color: #c58b35; }
.tone-cyan .stat-icon { color: #2f92ae; }
...
.visit-fill {
  background: linear-gradient(180deg, rgba(96, 152, 236, 0.86), rgba(96, 152, 236, 0.34));
}

.article-fill {
  background: linear-gradient(180deg, rgba(220, 100, 150, 0.82), rgba(220, 100, 150, 0.3));
}
...
.visit-dot { background: #6098ec; }
.article-dot { background: #dc6496; }
...
.tag-meter i {
  background: linear-gradient(90deg, rgba(90, 148, 230, 0.7), rgba(86, 190, 168, 0.7));
...
.comment-item:hover {
  background: rgba(255, 255, 255, 0.18);
  box-shadow: 0 8px 20px rgba(82, 142, 220, 0.16);
