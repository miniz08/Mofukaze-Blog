<template>
  <div class="collection-detail-page">
    <div>
      ...
      <button v-if="ifVisible" @click="editCollection" class="edit-button">编辑</button>
      <button v-if="ifVisible" @click="deleteCollection" class="delete-button">删除</button>
    </div>
...
const fetchCollectionContent = async (id: number) => {
  try {
    ...
    if (result) {
      ...
      imageSrc.value = `http://mofukaze.me/img/cover/${result[0].title}.jpeg`;
    }
  } finally {
